...
BasePage{
    id:root
    caption: qsTr("Drawer 4 Calibration") + mytrans.emptyString
    pageName: "DrawerMotor4"
    function init()
    {
        console.log("drawer 4 motor calibration");
    }
   GridLayout {
    id: grid
    width:500
    ...
    CalibreSettingsButton
    {
        text:"Up"
        width:150
        pressedKey:"calibration/fourth_drawer_up";
        releaseKey:"calibration/fourth_drawer_stop";
    }
    ...
    {
        text:"Down"
        pressedKey:"calibration/fourth_drawer_down";
        releaseKey:"calibration/fourth_drawer_stop";
    }
    ...
    {
        text:"Set Min"
        pressedKey:"calibration/fourth_drawer_min";
    }
    ...
    {
        text:"Set Maximum"
        pressedKey:"calibration/fourth_drawer_max";
    }
    ...
    {
        text:"Reset"
        pressedKey:"calibration/fourth_drawer_reset";
    }
    }
}
