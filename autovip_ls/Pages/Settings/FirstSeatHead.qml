...
BasePage{
    id:root
    caption: qsTr("First Sead Head Calibration") + mytrans.emptyString
    pageName: "FirstSeatHead"
    function init()
    {
        console.log("first sead head calibration");
    }
   GridLayout {
    id: grid
    width:500
    ...
    CalibreSettingsButton
    {
        text:"Forward"
        width:150
        pressedKey:"calibration/first_head_forward";
    }
    ...
    {
        text:"Backward"
        pressedKey:"calibration/first_head_backward";
    }
    ...
    {
        text:"Set"
        pressedKey:"calibration/first_head_set";
    }
    ...
    {
        text:"Set Minimum"
        pressedKey:"calibration/first_head_min";
    }
    ...
    {
        text:"Set Maximum"
        pressedKey:"calibration/first_head_max";
    }
}
