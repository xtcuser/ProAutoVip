...
BasePage{
    id:root
    caption: qsTr("Drawer 3 Calibration") + mytrans.emptyString
    pageName: "DrawerMotor3"
    function init()
    {
        console.log("drawer 3 motor calibration");
    }
   GridLayout {
    id: grid
    width:500
    ...
    CalibreSettingsButton
    {
        text:"Up"
        width:150
        pressedKey:"calibration/third_drawer_up";
        releaseKey:"calibration/third_drawer_stop";
    }
    ...
    {
        text:"Down";
        pressedKey:"calibration/third_drawer_down";
        releaseKey:"calibration/third_drawer_stop";
    }
    ...
    {
        text:"Set Min"
        pressedKey:"calibration/third_drawer_min";
    }
    ...
    {
        text:"Set Maximum"
        pressedKey:"calibration/third_drawer_max";
    }
    ...
    {
        text:"Reset"
        pressedKey:"calibration/third_drawer_reset";
    }
}
}
