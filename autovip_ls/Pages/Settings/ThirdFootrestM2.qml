...
BasePage{
    id:root
    caption: qsTr("Third Footrest M2 Calibration") + mytrans.emptyString
    pageName: "ThirdFootrestM2"
    function init()
    {
        console.log("Third Footrest Motor 2");
    }
   GridLayout {
    id: grid
    width:500
    ...
    CalibreSettingsButton
    {
        text:"Up"
        width:150
        pressedKey:"calibration/third_footrest2_up";
        releaseKey:"calibration/third_footrest2_stop";
    }
    ...
    {
        text:"Down"
        pressedKey:"calibration/third_footrest2_down";
        releaseKey:"calibration/third_footrest2_stop";
    }
    ...
    {
        text:"Set Min"
        pressedKey:"calibration/third_footrest2_min";
    }
    ...
    {
        text:"Set Maximum"
        pressedKey:"calibration/third_footrest2_max";
    }
    ...
    {
        text:"Reset"
        pressedKey:"calibration/third_footrest2_reset";
    }
}
