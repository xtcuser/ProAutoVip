...
Item {
    ...
    Image {
        id: tick
        source:   orientation === Qt.Vertical ? "qrc:/design/lights/left_tick.png" : "qrc:/design/lights/top_tick.png"
        x:        orientation === Qt.Vertical ? 0 : value * mouseArea.width - width / 2
        y:        orientation === Qt.Vertical ? value * mouseArea.height - height / 2 : 0
    }

    Image {
        source:   orientation === Qt.Vertical ? "qrc:/design/lights/right_tick.png" : "qrc:/design/lights/bottom_tick.png"
